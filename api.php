...
define('DB_SERVER', '127.0.0.1');    // GitHub Actions uses localhost
define('DB_USERNAME', 'root');       // default username
define('DB_PASSWORD', 'root');       // GA uses root password
define('DB_NAME', 'kontak');         // database created in CI
...
function validate_input($data){
    ...
    // FIX: email tidak harus @gmail.com, cukup valid format email
